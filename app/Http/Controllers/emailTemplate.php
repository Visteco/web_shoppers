        ...
        <tr>
            <td width="100%" align="center" valign="top"  bgcolor="062f3c" style="">
				...
				<table style="box-shadow:0px 0px 0px 0px #E0E0E0;"width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="container top-header-left">	
									...
									<td>
										<table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="logo">
											<tbody>
												...
												<tr>
													<td align="right">
														<a href="latest.visteco.com" class="logo-text" style="text-decoration:none;"><td class="thompson" align="center" style="font-size:1.8em;color:white;font-family:Candara;">visteco.com</td></a>
													</td>
												</tr>
											</tbody>
										</table>		
												...
												<tr>
													<td>
															...
															<tbody>
																<tr> 
																	<td class="mail_gd" align="center" style=" text-align: left; font-size:1.2em; font-family:Candara; color: #FFFFFF;">
																		<a href="mailto:info@visteco.com" style="color:#fff;text-decoration:none"><img src="http://latest.visteco.com/public/api/templateImage/envelope.png" alt="" border="0" height="18" width="18">&nbsp; &nbsp;visteco.com</a>
																	</td>
																</tr>
															</tbody>
														</table>
														<table class="mail_right" align="right" border="0" cellpadding="0" cellspacing="0" width="150">
															<tbody>
																<tr>			
																	<td align="center"  style="font-size:14px;color:#f5f5f5;font-family:Arial,serif"><img src="http://latest.visteco.com/public/api/templateImage/1.png" alt="" border="0" height="16" width="16">&nbsp; &nbsp;+91 120 412 9730</td>
																</tr>
															</tbody>
														</table>
													</td>
					...
					<tr>
						<td>
							<table class="ban-hei" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url(http://latest.visteco.com/public/api/templateImage/blindchatss.jpg); background-size:cover;" height="380">	
								<tbody>
									<tr>
														...
														<td>				
															<table class="ban_info" border="0" cellpadding="0" cellspacing="0"  width="500">				
																<tbody>
																	...
																	<tr>
																		<td class="future" style="font-size:2.3em;color:black;background-color:white;text-transform:capitalize;font-family:Candara;text-align:center;line-height:1.5em">Change Your Password</td>
																	</tr>	
																	<tr><td class="ban_tex" ></td></tr>	
																</tbody>
															</table>		
														</td>
													</tr>
								...
								<tbody>
									...
									<tr>
										<td class="wel_text" align="center" style="font-size:2.5em;color:#d70b03;font-family:Candara;text-align:center;font-weight:600;"> 
											Click on the Below Link for change your Password!
										</td>
									</tr>
									<tr>
										<td height="15"></td>
									...
									<tr>
										<td class="ser_text" align="center" style="color:#464646; font-size: 1.2em; font-family: Candara; line-height:1.8em;">
											<a href=<?php echo $link ?> >Change you password here</a>
										</td>
									</tr>
									...
									<tr>
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
												<tr>
													<td align="center">
														<img src="http://latest.visteco.com/public/api/templateImage/applogo.png" alt=" " class="img-responsive" style="text-align:center;" width="130" height="130" />
													</td>
												</tr>
												
												<tr>
													<td class="thompson" align="center" style="font-size:1.8em;color:#8c8c8c;font-family:Candara;">ABOUT US</td>
												</tr>
												...
												<tr>
													<td class="ser_text" align="justify" style="font-size:1.1em;color:#464646;line-height:1.8em;font-family:Candara;">
														<p>Description</p>
													</td>
												</tr>
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                    <a href="http://webcoir.com/" style="color:#ffffff;text-decoration:none;" data-size="Footer Text" data-color="Footer Text">
                                                                                                            <img src="http://latest.visteco.com/public/api/templateImage/webcoirlogo.png" width="100" height="50" alt="">
                                                                                                    </a>
                                                                                                    </td>
                                                                                                </tr>
													...
													<table border="0" width="100%">
														<tbody>
															<tr>
																<td width="22">
																	<a href="#">
																		<img src="http://latest.visteco.com/public/api/templateImage/icon1.png" width="22" height="22" alt="">
																	</a>
																</td>
																<td width="1">
																</td>
																<td width="22">
																	<a href="#">
																		<img src="http://latest.visteco.com/public/api/templateImage/icon2.png" width="22" height="22" alt="">
																	</a>
																</td>
																<td width="1">
																</td>
																...
																<td width="22">
																	<a href="#">
																		<img src="http://latest.visteco.com/public/api/templateImage/icon4.png" width="22" height="22" alt="">
																	</a>
																</td>
																<td width="1">
																</td>
																<td width="22">
																	<a href="#">
																		<img src="http://latest.visteco.com/public/api/templateImage/icon5.png" width="22" height="22" alt="">
																	</a>
																</td>
															</tr>
														</tbody>
								...
								<tr>
									...
									<tr>
										<td>
											...
											<table class="foo" width="600" border="0" align="left" cellpadding="0" cellspacing="0">
												<tr>
													<td align="center" class="ser_text editable"style="font-family: Candara; font-size: 1em; color: #ffffff; line-height: 24px;">
														 <a href="http://webcoir.com/" style="color: #fff; font-size: 1em;text-decoration:none;"> Webcoir IT Solutions</a>
													</td>
												</tr>
											</table>
