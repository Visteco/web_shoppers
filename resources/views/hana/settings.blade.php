...
@include('hana.adUpdateModal')
@include('hana.listForBlockUserModal')
@section('content')
<?php 
$post_Display=1;
$contact=2;
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-lg-2 about_box">
                <div class="row">
                    <div class="col-lg-12 setting_tab shadow_box">
                        <ul>
                            <li @if($generalSetting==1) echo class="1st" @endif >General Settings </li>
                           <li @if($generalSetting==2) class="1st" @endif >Security Settings </li>
                            <li @if($generalSetting==3) class="1st" @endif >Privacy Settings </li>
                            <li @if($generalSetting==4) class="1st" @endif >Manage blocking </li>
                            <li @if($generalSetting==5) class="1st" @endif >Mobile Settings</li>
                            <li @if($generalSetting==6) class="1st" @endif >Social Links Settings </li>
                            <li @if($generalSetting==7) class="1st" @endif">Advertisement Add </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 about_box">
                <div class="row ">
                    <div @if($generalSetting==1) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif>
                        <div class="pro_text">
				...
				@endif
                    ...
                    <div @if($generalSetting==3) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif >
				...
				@endif
                                ...
                                <div class="col-md-12">
                                    <select name="stuffItem" id="stuffItem" class="form-control stuffItem" disabled="disabled">
                                        ...
                                        <option value="2" <?php if ($post_Display==2) echo 'selected="selected"'; ?>>Follower's</option>
                                        <option  value="3" <?php if ($post_Display==3) echo 'selected="selected"'; ?>>Follower's of Follower's</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <select name="contactMeItem" id="contactMeItem" class="form-control contactMeItem" disabled="disabled">
                                        ...
                                        <option value="2" <?php if ($contact==2) echo 'selected="selected"'; ?>>Follower's</option>
                                        <option value="3" <?php if ($contact==3) echo 'selected="selected"'; ?>>Follower's of Follower's</option>
                    ...
                    <div @if($generalSetting==4) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif>
                        <div class="pro_text">
                            ...
                            <div class="row">
                               <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul>
                                       @foreach($blockedUserList as $list)
                                        <li> <span> <i class="fa fa-ban" aria-hidden="true"></i> {{$list['name']}}</span>  <a href="{{ URL::to('settings/unblock/'.$list['uid'])}}">unblock</a></li>
                                        @endforeach
                    ...
                    <div @if($generalSetting==5) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif>
                        <div class="pro_text">
				...
				@endif
                    ...
                    <div @if($generalSetting==6) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif>
				...
				@endif
                    ...
                    <div @if($generalSetting==7) class="col-lg-12 setting_box 1st_box" @else class="col-lg-12 setting_box" @endif>
                        <div class="pro_text">
...
<script>
 ...
 // alert("Test"+adId);
 var url="/public/user/updateAds/"+adId;
...
$(document).on("click", "#blockusers", function() {
    var userName = document.getElementById("blockUsers").value;
     var url="/public/settings/blockUsernames/"+userName;
$.get(url, function(data){
        $("#ad_list").html(data);
    });
});
