...
$all='all';
$followersTotal=count($getFollowersUserList)+count($getFollowerscompanyList);
$followingCount=count($followingCompany)+count($followingUser);
                ...
                <div class="col-md-2">
                    <div class="row"> 
                        <div class="col-md-12 shadow_box mypro">
                            ...
                            <h4>Following</h4>
                            <div class="conct">
                               @foreach($followingCompany as $follow)
                               <?php if($follow->image) { ?>
                                    <img src="{{ URL::to('userimages/user_'.$follow->followingUser.'/medium/'.$follow->image ) }}" alt="...">
                                <?php  $countfollowing++;
                               }
                                ...
                                <?php  if($countfollowing<5) { ?>   
                                 @foreach($followingUser as $follow)
                                 <?php if($follow->image) { ?>
                                    <img src="{{ URL::to('userimages/user_'.$follow->followingUser.'/medium/'.$follow->image ) }}" alt="...">
                                <?php $countfollowing++;
                                 }
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="45%" style="text-align:right;">
                                                ...
                                                <button class="skybtn" onclick="doFollow('{{ URL::to('followcompany/'.$follow->followingUser) }}',this)">Following</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @foreach($followingUser as $follow)
                                        <tr>
                                            ...
                                            <td width="45%" style="text-align:right;">
                                                <button class="skybtn">Message</button>
                                                 <button class="skybtn" onclick="doFollow('{{ URL::to('followuser/'.$follow->followingUser) }}',this)">Following</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
