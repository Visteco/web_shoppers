    ...
    <div class="container-fluid">
        <div class="container no-gutter">
            <div class="row about_box">
                ...
                <form action="{{ URL::to('jobs/searchjobs') }}">    
                    {{ csrf_field() }}
                    <div class="col-lg-12 jobsearch sbanner clearfix">
                        
                        <div class="js1">
                            
                            <input type="text" name="keywords" placeholder="Job role, keywords or company name">
                        ...
                        <div class="js2">
                            ...
                            <button><i class="fa fa-search" aria-hidden="true">&nbsp;</i><span>FIND JOBS</span></button>
                        </div>
                    ...
                    <div class="col-lg-12 jobbox">
                        ...
                        <div class="row">
                            ...
                            <div class="jobtitle">
                                <a href="{{URL::to('user/jobdetail')}}"><h2>{{ $job->title }}</h2></a>
                                <h6>{{ $job->title }}</h6>
                                <ul>
                                    <li>
                        ...
                        <div class="row">
                            <p>{{ $job->about_us }}<a href="{{ URL::to('user/jobdetail/'.$job->job_id) }}">read more</a></p>
                        </div>
