            ...
            <div class="row">
                <div class="uprofile clearfix">
                    ...
                    <div id="load_profile" class="loding" style="display:none;">
                        <span class="load_img"> <img src="http://visteco.com/images/loading_new.gif"></span> 
                    </div>
                    </form>
                       </div>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <ul id="sources-list">
                                ...
                                <li>
                                   ...
                                   <button class="followbtn" onclick="doFollow('{{ URL::to('followcompany/'.$follow->followingUser) }}',this)">Follow</button>
                                </li>
                                <?php
                                $followerCompCount++;
                            ...
                            @foreach($getFollowersUserList as $follow)
                                <li>
                                    ...
                                    <button class="followbtn" onclick="doFollow('{{ URL::to('followuser/'.$follow->followingUser) }}',this)">Follow</button>
                                </li>
                                <?php
                                $followerUserCount++;
