...
<!-- Modal -->
<div class="modal fade model_offset in sarv-model" id="ankur_card" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
			...
			<div class="modal-body" style="padding: 0px 55px;">
				<div class="row">
					<div class="vcrd">
						...
						<div class="uproname">  
							<div class="uprofiledes">Ankur Sharma</div>
							<div class="uprofilecomp">Web Devloper (Php)</div>
							<div class="uprofilecomp">at  <a href="">Webcoir It Solutions Pvt Ltd</a></div>	
						</div>
						<div class="vcrd_soc">
